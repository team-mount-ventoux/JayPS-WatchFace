...
void screen_debug1_layer_init(Window* window) {
  ...
  set_layer_attr_full(s_data.debug1_layer, s_data.debug1, font_18, GTextAlignmentLeft, GColorBlack, GColorWhite, s_data.page_debug1);
...
void screen_debug2_layer_init(Window* window) {
  ...
  set_layer_attr_full(s_data.debug2_layer, s_data.debug2, font_18, GTextAlignmentLeft, GColorBlack, GColorWhite, s_data.page_debug2);
